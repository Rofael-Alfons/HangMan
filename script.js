...
let options = {
  ...
  names: ["Mark","Rofa","Remon","Micheal","Maivel","Joseph","Sally","George","Moshera","Mina","Jan"],
  countries: [
    "India",
    "Hungary",
    "Kyrgyzstan",
...
// Word Generator
const generateWord = function (optionValue) {
  let optionsButtons = document.querySelectorAll(".options");
  optionsButtons.forEach((button) => {
...
// New Game
newGameButton.addEventListener("click", initialzer);
window.onload = initialzer;
